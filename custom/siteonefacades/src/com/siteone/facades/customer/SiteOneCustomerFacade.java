...
//import org.springframework.security.oauth2.common.exceptions.InvalidBearerTokenException;
...
public interface SiteOneCustomerFacade
{
	...
	String resetPassword(String stateToken, String newPassword) throws InvalidBearerTokenException, PasswordPolicyViolationException,
