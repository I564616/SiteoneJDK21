...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneStoreDetailsPromoComponent SiteOneStoreDetailsPromoComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneStoreDetailsPromoComponent extends SimpleBannerComponent
{
	/** Qualifier of the <code>SiteOneStoreDetailsPromoComponent.promotionalText</code> attribute **/
	public static final String PROMOTIONALTEXT = "promotionalText";
	/** Qualifier of the <code>SiteOneStoreDetailsPromoComponent.subheadText</code> attribute **/
	public static final String SUBHEADTEXT = "subheadText";
	/** Qualifier of the <code>SiteOneStoreDetailsPromoComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneStoreDetailsPromoComponent.buttonURL</code> attribute **/
	public static final String BUTTONURL = "buttonURL";
	/** Qualifier of the <code>SiteOneStoreDetailsPromoComponent.icon</code> attribute **/
	public static final String ICON = "icon";
	/** Qualifier of the <code>SiteOneStoreDetailsPromoComponent.headline</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailsPromoComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailsPromoComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailsPromoComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailsPromoComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailsPromoComponent.buttonURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailsPromoComponent.buttonURL</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailsPromoComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailsPromoComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailsPromoComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailsPromoComponent.setHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailsPromoComponent.icon</code> attribute.
	 * @return the icon
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailsPromoComponent.icon</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailsPromoComponent.promotionalText</code> attribute.
	...
	public String getPromotionalText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailsPromoComponent.getPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailsPromoComponent.promotionalText</code> attribute. 
	...
	public void setPromotionalText(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailsPromoComponent.setPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailsPromoComponent.subheadText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailsPromoComponent.subheadText</code> attribute. 
