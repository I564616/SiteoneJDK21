...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneCuratedPLPPromoComponent SiteOneCuratedPLPPromoComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneCuratedPLPPromoComponent extends SimpleBannerComponent
{
	/** Qualifier of the <code>SiteOneCuratedPLPPromoComponent.promotionalText</code> attribute **/
	public static final String PROMOTIONALTEXT = "promotionalText";
	/** Qualifier of the <code>SiteOneCuratedPLPPromoComponent.subheadText</code> attribute **/
	public static final String SUBHEADTEXT = "subheadText";
	/** Qualifier of the <code>SiteOneCuratedPLPPromoComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneCuratedPLPPromoComponent.buttonURL</code> attribute **/
	public static final String BUTTONURL = "buttonURL";
	/** Qualifier of the <code>SiteOneCuratedPLPPromoComponent.icon</code> attribute **/
	public static final String ICON = "icon";
	/** Qualifier of the <code>SiteOneCuratedPLPPromoComponent.headline</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPPromoComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPPromoComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPPromoComponent.buttonURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPPromoComponent.buttonURL</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPPromoComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPPromoComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoComponent.setHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPPromoComponent.icon</code> attribute.
	 * @return the icon
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPPromoComponent.icon</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPPromoComponent.promotionalText</code> attribute.
	...
	public String getPromotionalText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoComponent.getPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPPromoComponent.promotionalText</code> attribute. 
	...
	public void setPromotionalText(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoComponent.setPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPPromoComponent.subheadText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPPromoComponent.subheadText</code> attribute. 
