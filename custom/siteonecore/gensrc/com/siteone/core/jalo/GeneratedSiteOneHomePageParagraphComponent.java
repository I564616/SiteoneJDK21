...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneHomePageParagraphComponent SiteOneHomePageParagraphComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneHomePageParagraphComponent extends CMSParagraphComponent
{
	/** Qualifier of the <code>SiteOneHomePageParagraphComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneHomePageParagraphComponent.buttonUrl</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneHomePageParagraphComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneHomePageParagraphComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneHomePageParagraphComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneHomePageParagraphComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneHomePageParagraphComponent.buttonUrl</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneHomePageParagraphComponent.buttonUrl</code> attribute. 
