...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteonePageTitleBannerComponent SiteonePageTitleBannerComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteonePageTitleBannerComponent extends SimpleBannerComponent
{
	/** Qualifier of the <code>SiteonePageTitleBannerComponent.headline</code> attribute **/
	public static final String HEADLINE = "headline";
	/** Qualifier of the <code>SiteonePageTitleBannerComponent.content</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteonePageTitleBannerComponent.content</code> attribute.
	 * @return the content
	 */
	public String getContent(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteonePageTitleBannerComponent.getContent requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteonePageTitleBannerComponent.content</code> attribute. 
	...
	public void setContent(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteonePageTitleBannerComponent.setContent requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteonePageTitleBannerComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteonePageTitleBannerComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteonePageTitleBannerComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteonePageTitleBannerComponent.setHeadline requires a session language", 0 );
		}
