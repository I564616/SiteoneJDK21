...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteoneParagaraphComponent SiteoneArticleCategoryParagaraphComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteoneParagaraphComponent extends CMSParagraphComponent
{
	/** Qualifier of the <code>SiteoneArticleCategoryParagaraphComponent.headline</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneArticleCategoryParagaraphComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneParagaraphComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneArticleCategoryParagaraphComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneParagaraphComponent.setHeadline requires a session language", 0 );
		}
