...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneCuratedPLPHeaderComponent SiteOneCuratedPLPHeaderComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneCuratedPLPHeaderComponent extends BannerComponent
{
	/** Qualifier of the <code>SiteOneCuratedPLPHeaderComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneCuratedPLPHeaderComponent.buttonURL</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPHeaderComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPHeaderComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPHeaderComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPHeaderComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPHeaderComponent.buttonURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPHeaderComponent.buttonURL</code> attribute. 
