...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteoneContactUsComponent SiteoneContactUsComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteoneContactUsComponent extends CMSParagraphComponent
{
	/** Qualifier of the <code>SiteoneContactUsComponent.headline</code> attribute **/
	public static final String HEADLINE = "headline";
	/** Qualifier of the <code>SiteoneContactUsComponent.media</code> attribute **/
	public static final String MEDIA = "media";
	/** Qualifier of the <code>SiteoneContactUsComponent.urlLink</code> attribute **/
	public static final String URLLINK = "urlLink";
	/** Qualifier of the <code>SiteoneContactUsComponent.external</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneContactUsComponent.external</code> attribute.
	 * @return the external
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneContactUsComponent.external</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneContactUsComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneContactUsComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneContactUsComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneContactUsComponent.setHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneContactUsComponent.media</code> attribute.
	 * @return the media
	 */
	public Media getMedia(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneContactUsComponent.getMedia requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneContactUsComponent.media</code> attribute. 
	...
	public void setMedia(final SessionContext ctx, final Media value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneContactUsComponent.setMedia requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneContactUsComponent.urlLink</code> attribute.
	 * @return the urlLink
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneContactUsComponent.urlLink</code> attribute. 
