...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneStoreDetailPromoComponent SiteOneStoreDetailPromoComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneStoreDetailPromoComponent extends SimpleBannerComponent
{
	/** Qualifier of the <code>SiteOneStoreDetailPromoComponent.promotionalText</code> attribute **/
	public static final String PROMOTIONALTEXT = "promotionalText";
	/** Qualifier of the <code>SiteOneStoreDetailPromoComponent.subheadText</code> attribute **/
	public static final String SUBHEADTEXT = "subheadText";
	/** Qualifier of the <code>SiteOneStoreDetailPromoComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneStoreDetailPromoComponent.buttonURL</code> attribute **/
	public static final String BUTTONURL = "buttonURL";
	/** Qualifier of the <code>SiteOneStoreDetailPromoComponent.icon</code> attribute **/
	public static final String ICON = "icon";
	/** Qualifier of the <code>SiteOneStoreDetailPromoComponent.headline</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailPromoComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailPromoComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailPromoComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailPromoComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailPromoComponent.buttonURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailPromoComponent.buttonURL</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailPromoComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailPromoComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailPromoComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailPromoComponent.setHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailPromoComponent.icon</code> attribute.
	 * @return the icon
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailPromoComponent.icon</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailPromoComponent.promotionalText</code> attribute.
	...
	public String getPromotionalText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailPromoComponent.getPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailPromoComponent.promotionalText</code> attribute. 
	...
	public void setPromotionalText(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneStoreDetailPromoComponent.setPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneStoreDetailPromoComponent.subheadText</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneStoreDetailPromoComponent.subheadText</code> attribute. 
