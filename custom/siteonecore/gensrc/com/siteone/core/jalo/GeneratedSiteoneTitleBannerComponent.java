...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteoneTitleBannerComponent SiteoneTitleBannerComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteoneTitleBannerComponent extends SimpleBannerComponent
{
	/** Qualifier of the <code>SiteoneTitleBannerComponent.headline</code> attribute **/
	public static final String HEADLINE = "headline";
	/** Qualifier of the <code>SiteoneTitleBannerComponent.content</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneTitleBannerComponent.content</code> attribute.
	 * @return the content
	 */
	public String getContent(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneTitleBannerComponent.getContent requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneTitleBannerComponent.content</code> attribute. 
	...
	public void setContent(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneTitleBannerComponent.setContent requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteoneTitleBannerComponent.headline</code> attribute.
	 * @return the headline
	 */
	public String getHeadline(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneTitleBannerComponent.getHeadline requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteoneTitleBannerComponent.headline</code> attribute. 
	...
	public void setHeadline(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteoneTitleBannerComponent.setHeadline requires a session language", 0 );
		}
