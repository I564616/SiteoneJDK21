...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneLoginPageComponent SiteOneLoginPageComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneLoginPageComponent extends CMSParagraphComponent
{
	/** Qualifier of the <code>SiteOneLoginPageComponent.promotionalText</code> attribute **/
	public static final String PROMOTIONALTEXT = "promotionalText";
	/** Qualifier of the <code>SiteOneLoginPageComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneLoginPageComponent.buttonURL</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneLoginPageComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneLoginPageComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneLoginPageComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneLoginPageComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneLoginPageComponent.buttonURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneLoginPageComponent.buttonURL</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneLoginPageComponent.promotionalText</code> attribute.
	...
	public String getPromotionalText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneLoginPageComponent.getPromotionalText requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneLoginPageComponent.promotionalText</code> attribute. 
	...
	public void setPromotionalText(final SessionContext ctx, final String value)
	{
		...
		if( ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneLoginPageComponent.setPromotionalText requires a session language", 0 );
		}
