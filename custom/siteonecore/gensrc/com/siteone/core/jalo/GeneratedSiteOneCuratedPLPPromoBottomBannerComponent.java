...
/**
 * Generated class for type {@link com.siteone.core.jalo.SiteOneCuratedPLPPromoBottomBannerComponent SiteOneCuratedPLPBottomPromoBannerComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedSiteOneCuratedPLPPromoBottomBannerComponent extends BannerComponent
{
	/** Qualifier of the <code>SiteOneCuratedPLPBottomPromoBannerComponent.buttonLabel</code> attribute **/
	public static final String BUTTONLABEL = "buttonLabel";
	/** Qualifier of the <code>SiteOneCuratedPLPBottomPromoBannerComponent.buttonURL</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPBottomPromoBannerComponent.buttonLabel</code> attribute.
	...
	public String getButtonLabel(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoBottomBannerComponent.getButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPBottomPromoBannerComponent.buttonLabel</code> attribute. 
	...
	public void setButtonLabel(final SessionContext ctx, final String value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedSiteOneCuratedPLPPromoBottomBannerComponent.setButtonLabel requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>SiteOneCuratedPLPBottomPromoBannerComponent.buttonURL</code> attribute.
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>SiteOneCuratedPLPBottomPromoBannerComponent.buttonURL</code> attribute. 
