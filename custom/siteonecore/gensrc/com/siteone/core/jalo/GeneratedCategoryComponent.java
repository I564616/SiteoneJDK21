...
/**
 * Generated class for type {@link com.siteone.core.jalo.CategoryComponent CategoryComponent}.
 */
@SuppressWarnings({"deprecation","unused","cast"})
public abstract class GeneratedCategoryComponent extends SimpleCMSComponent
{
	/** Qualifier of the <code>CategoryComponent.category</code> attribute **/
	public static final String CATEGORY = "category";
	/** Qualifier of the <code>CategoryComponent.media</code> attribute **/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CategoryComponent.category</code> attribute.
	 * @return the category
	 */
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CategoryComponent.category</code> attribute. 
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>CategoryComponent.media</code> attribute.
	 * @return the media
	 */
	public Media getMedia(final SessionContext ctx)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedCategoryComponent.getMedia requires a session language", 0 );
		}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>CategoryComponent.media</code> attribute. 
	...
	public void setMedia(final SessionContext ctx, final Media value)
	{
		...
		{
			throw new JaloInvalidParameterException("GeneratedCategoryComponent.setMedia requires a session language", 0 );
		}
